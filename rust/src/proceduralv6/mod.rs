...
impl SolverProce<CellV6> for SolverProceV6 {
    fn get_cell(&self, x: usize, y: usize) -> &CellV6 {
        &self.grid[y][x]
    }

    fn get_cell_mut(&mut self, x: usize, y: usize) -> &mut CellV6 {
        &mut self.grid[y][x]
    }
}
