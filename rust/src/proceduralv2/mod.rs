...
impl SolverProce<CellV2> for SolverProceV2 {
    fn get_cell(&self, x: usize, y: usize) -> &CellV2 {
        &self.grid[y][x]
    }

    fn get_cell_mut(&mut self, x: usize, y: usize) -> &mut CellV2 {
        &mut self.grid[y][x]
    }
}
