...
use crate::proceduralv1::cell_v1::CellV1;
...
impl SolverProce<CellV1> for SolverProceV1 {
    fn get_cell(&self, x: usize, y: usize) -> &CellV1 {
        &self.grid[y][x]
    }

    fn get_cell_mut(&mut self, x: usize, y: usize) -> &mut CellV1 {
        &mut self.grid[y][x]
    }
}
